...
def main():
    ...
    for league in leagues:
        ...
        df = cr.generate_league_df(
            league, team_list, desired_fields, desired_seasons, table_ids, data_attr
        )

        name_mapping = reference_df[reference_df["league"] == league][
            ["team", "full_name"]
        ]

        prepared_data = cr.prepare_league_data(
            df, league, final_columns, reordered_columns, name_mapping
        )
