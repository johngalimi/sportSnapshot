...
docker build -t sportsnapshot .; docker run -it sportsnapshot
...
# server
docker build -f service.Dockerfile . -t sportsservice; docker run --rm -p 5000:5000 sportsservice
